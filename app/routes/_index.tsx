...
import { DAY_IN_MS, dateFromWeek, isToday, weekOfYear } from "~/utils/date";
		...
		<div className="flex h-full flex-col">
			<header className="flex flex-none items-center justify-between border-b border-gray-200 px-6 py-4">
				...
				<div className="flex items-center">
					<Form className="relative flex items-center rounded-md bg-white shadow-sm md:items-stretch">
						<button
							name="week"
							value={week - 1}
								...
								>
									...
									<span
										className={classNames(
											...
											d.getMonth() === startDate.getMonth() ? "text-gray-900 font-semibold" : "text-gray-400"
										)}
									>
										{d.getDate()}
									</span>
								...
								>
									...
									>
										...
										<span
											...
											d.getMonth() === startDate.getMonth() ? "text-gray-900" : "text-gray-400"
											)}
										>
											{d.getDate()}
										</span>
